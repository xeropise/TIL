...
## __[Cross-Origin Resource Sharing(CORS)](https://developer.mozilla.org/ko/docs/Web/HTTP/CORS) - 서버 해결 방법__

## __[프록시 서버(Proxy Server)]() - 클라이언트 쪽 해결 방법__

- 망할 회사 배포때문에 추후 이어서 쓸 예정
